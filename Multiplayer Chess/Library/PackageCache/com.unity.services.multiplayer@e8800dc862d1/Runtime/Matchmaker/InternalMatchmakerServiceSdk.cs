...
namespace Unity.Services.Matchmaker
{
    ...
    internal class InternalMatchmakerServiceSdk : IMatchmakerServiceSdk
    {
        ...
        /// </param>
        public InternalMatchmakerServiceSdk(HttpClient httpClient, string cloudEnvironment = "production", IAccessToken accessToken = null, IServerAccessToken serverAccessToken = null)
        {
